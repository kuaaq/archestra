...
export const TOOL_SORTING_HAT_SORT_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_SORTING_HAT_SORT_SHORT_NAME}` as const;
export const TOOL_PATRONUS_CAST_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_PATRONUS_CAST_SHORT_NAME}` as const;
export const TOOL_FLOO_TRAVEL_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_FLOO_TRAVEL_SHORT_NAME}` as const;
export const TOOL_QUIDDITCH_STREAM_FULL_NAME =
  `${ARCHESTRA_TOOL_PREFIX}${TOOL_QUIDDITCH_STREAM_SHORT_NAME}` as const;
